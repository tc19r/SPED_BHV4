...
[2] Garett Ordway, Tingan Chen, Vic Patrangenaru(2026). Continuing Investigations in the BHV Tree Space. DOI: 10.13140/RG.2.2.21497.94569 (2026)
...
The dataset used in this work is from [this paper in Nature] (https://www.nature.com/articles/s41586-018-0030-5). 
The results in this work are fully reproducible using the random seed set in the main.py file, which only influenece the nonparametric bootsrap used to estimate the confidence intervals. 
